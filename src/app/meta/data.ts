...
export const detailedMetrics = {
  ...
  bestRoasCampaigns: [
    { name: 'Campanha A', value: 5.5, fill: 'var(--color-chart-1)' },
    { name: 'Campanha B', value: 4.8, fill: 'var(--color-chart-2)' },
    { name: 'Campanha C', value: 4.2, fill: 'var(--color-chart-3)' },
    { name: 'Outras', value: 3.5, fill: 'var(--color-chart-4)' },
  ],
  lowestCpaAds: [
    { name: 'Anúncio X', value: 10, fill: 'var(--color-chart-1)' },
    { name: 'Anúncio Y', value: 12, fill: 'var(--color-chart-2)' },
    { name: 'Anúncio Z', value: 15, fill: 'var(--color-chart-3)' },
    { name: 'Outros', value: 18, fill: 'var(--color-chart-4)' },
  ],
  comparisonTable: [
